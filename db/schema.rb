...
ActiveRecord::Schema.define(version: 20170126174146) do
  ...
  create_table "edutypes", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "places", force: :cascade do |t|
    ...
    t.index ["edutype_id"], name: "index_places_on_edutype_id", using: :btree
  end
